...
import com.sanmer.mrepo.utils.mmkv.IMMKVHandler
...
class MRepoApp : Application() {
    override fun onCreate() {
        ...
        MMKV.registerHandler(IMMKVHandler())
        ...
        MagiskUtils.getApp(this)
        Timber.d("MagiskApp: ${MagiskUtils.packageName}")
    }
}