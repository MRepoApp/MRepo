package com.sanmer.mrepo.ui.modify
 ...
 * @param lineStrokeCap stroke cap of the line
 */
@Composable
fun LinearProgressIndicator(
    ...
    Canvas(
        ...
        drawLinearIndicatorTrack(trackColor, strokeWidth, lineStrokeCap)
        drawLinearIndicator(0f, progress, color, strokeWidth, lineStrokeCap)
    }
}
 ...
 * @param arcStrokeCap stroke cap of the arc
 */
@Composable
fun CircularProgressIndicator(
    ...
    val stroke = with(LocalDensity.current) {
        Stroke(width = strokeWidth.toPx(), cap = arcStrokeCap)
    }
    Canvas(
        modifier
            .progressSemantics(progress)
