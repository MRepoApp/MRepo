package dev.sanmer.mrepo.compat.utils
...
internal fun File.unzip(folder: File, path: String = "", junkPath: Boolean = false) {
...
@Throws(IOException::class)
internal fun InputStream.unzip(folder: File, path: String, junkPath: Boolean) {
    try {
